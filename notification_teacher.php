    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div style="background-color: #3385ff; width: 300px; height: 1800px; margin-left: -30px; margin-top: -20px;">
				
				</div>
                <div class="span9" id="content" style="margin-top: -1750px; margin-left: 350px;">
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     <ul class="breadcrumb">
						<?php
