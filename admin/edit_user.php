    ...
    <body>
		...
		<?php include('navbar1.php') ?></div>
            <div class="row-fluid">
				...
				<div style="margin-left: 300px; margin-right: -400px; margin-top: 30px;">
				<?php include('edit_user_form.php'); ?></div>		   			
				</div>
                <div class="span6" id="" style="margin-left: 800px; margin-top: -300px;">
                     <div class="row-fluid">
                        <!-- block -->
