...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            ...
            <div style="background-color: #3385ff; width: 300px; height: 1900px; margin-left: -30px; margin-top: -20px;">
				
				</div>
                <div class="span9" id="content" style="margin-top: -1900px; margin-left: 300px;">
                     <div class="row-fluid">
					    <!-- breadcrumb -->
