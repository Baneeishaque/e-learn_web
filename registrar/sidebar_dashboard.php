     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="Registrar_message.php"><i class="icon-chevron-right"></i><i class="icon-list-alt"></i> Message</a>
                        </li>
                        <li>
                            <a href="subjects.php"><i class="icon-chevron-right"></i><i class="icon-list-alt"></i> Notification</a>
                        </li>
						...
						<li>
                            <a href="Coordinator.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Coordinator</a>
                        </li>
