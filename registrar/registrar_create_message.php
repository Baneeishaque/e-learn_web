                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										<li>
											<a href="registrar_message.php">For Coordinator</a>
										</li>
										<li class="active"><a href="registrar_student.php">For Admin</a></li>
									</ul>
									...
									<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="admin_id"  class="chzn-select" required>
                                             	<option></option>
											<?php
											$query = mysql_query("select * from users order by firstname");
