<div class="span3" id="">
	<div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										<li class="active">
											<a href="coordinator_message.php">For Registrar</a>
										</li>
										<
									</ul>
									...
									<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="user_id"  class="chzn-select" required>
                                             	<option></option>
											<?php
											$query = mysql_query("select * from registrar order by firstname");
			...
			jQuery("#send_message").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "csend_message.php",
						data: formData,
						success: function(html){
						
						$.jGrowl("Message Successfully Sended", { header: 'Message Sent' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'coordinator_message.php'  }, delay);  
