     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>
                            <a href="coordinator.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Coordinators</a>
                        </li>
                        <li>
                            <a href="admin_message.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Message</a>
                        </li>
						<li>
                            <a href="downloadable.php"><i class="icon-chevron-right"></i><i class="icon-download"></i> Downloadable User Log</a>
                        </li>
						<li>
                            <a href="assignment.php"><i class="icon-chevron-right"></i><i class="icon-upload"></i>Assignments Log</a>
                        </li>
                        <li>
                            <a href="exam.php"><i class="icon-chevron-right"></i><i class="icon-upload"></i>Exam Log</a>
                        </li>
						<li>
