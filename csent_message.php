                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class="">
										<a href="coordinator_message.php"><i class="icon-envelope-alt"></i>inbox</a>
										</li>
										<li class="active">
										<a href="csent_message.php"><i class="icon-envelope-alt"></i>Sent messages</a>
										</li>
										</ul>
									
								<?php
								 $query_announcement = mysql_query("select * from message_sent
																	LEFT JOIN registrar ON registrar.user_id = message_sent.reciever_id
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			return false;
				...
				<?php include('ccreate_message.php') ?>
            </div>
