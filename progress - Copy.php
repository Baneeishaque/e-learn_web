                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="" style="margin-left: 20px;">
										<thead>
										        <tr>
												<th>Quiz Title</th>
												<th>Description</th>
                              		...
                              		<?php
										...
										$query1 = mysql_query("select * from student_assignment where student_id = '$session_id'")or die(mysql_error());
									...
									?>          
										...
										/*
										$query = mysql_query("select * from student_assignment
										LEFT JOIN class ON student_assignment.student_id =student_class_quiz.student_id
										LEFT JOIN subject ON quiz.teacher_id = assignment.teacher_id
