			...
			<?php include('sidebar_dashboard.php'); ?>
               <div class="span6" id="content">
                     <div class="row-fluid">
                        ...
                        <!-- block -->
                        <div id="block_bg" class="block" style="margin-left: 300px; width: 600px;">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								 ...
								 $query_announcement = mysql_query("select * from message
																	LEFT JOIN registrar ON registrar.user_id = message.sender_id
								 ...
								 ?>
											...
											<i class="icon-calendar"></i> <?php echo $row['date_sended']; ?>
													<div class="pull-right">
														<a   href="#reply<?php echo $id; ?>" data-toggle="modal" ><i class="icon-reply"></i> Reply </a>
													</div>
													<div class="pull-right">
													<a   href="#<?php echo $id; ?>" data-toggle="modal" ><i class="icon-remove"></i> Remove </a>
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			jQuery("#reply").submit(function(e){
                ...
                <div style="margin-left: 1000px; margin-right: -850px;">
